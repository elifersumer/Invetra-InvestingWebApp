<template>
    ...
    <div class="col-md-8 font-oswald">
        <div class="py-20">
            <p class="font-bold w-1/4 text-center mx-auto">Tesla, Inc. (TSLA)</p>
            <p class="text-center text-sm">NasdaqGS - NasdaqGS Real Time Price. Currency in USD</p>
            <p class="text-center text-xxs">As of 12:10PM EST</p>
            <div id="myDiv"></div>
        </div>     
    </div>
</template>
...
import axios from "axios"
    export default {  
        ...
        mounted() {
            axios.get("https://financialmodelingprep.com/api/v3/historical-price-full/TSLA?timeseries=180&apikey=b6b90c304ec78fa2c95ce348d5d2447a")
                .then(res=>{
